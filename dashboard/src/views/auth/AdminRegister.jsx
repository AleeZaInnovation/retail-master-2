...
import { messageClear, owner_register } from '../../store/reducers/authReducer'
        ...
        <div className='min-w-screen min-h-screen bg-[#161d31] flex justify-center items-center'>
            <div className='w-[350px] text-[#d0d2d6] p-2'>
                <div className='bg-[#283046] p-4 rounded-md'>
                    <h2 className='text-xl mb-3'>Welcome to Retail Master</h2>
                    ...
                    <form onSubmit={submit}>
                        ...
                        <div className='flex flex-col w-full gap-1 mb-3'>
                            ...
                            <input onChange={inputHandle} value={state.note} className='px-3 py-2 outline-none border border-slate-700 bg-transparent rounded-md text-[#d0d2d6] focus:border-indigo-500 overflow-hidden' type="mobile_no" name='mobile_no' placeholder='Mobile No' id='mobile_no' required />
                        </div>
                        ...
                        <div className='flex items-center mb-3 gap-3 justify-center'>
                            <p>Already have an account ? <Link to='/admin/login'>Signin here</Link></p>
                        </div>
