...
import { get_payment_parties, partyNewAdd } from "../../store/reducers/partyReducer";
import {
  get_branch_services,
  get_company_service,
  make_service,
...
const Service = () => {
  ...
  const serviceHandler = ({ serviceProduct, description, party }) => {
    if (!serviceProduct || !description || !party) {
      toast.error("Please fill in all inputs");
    } else {
      dispatch(make_service({ serviceProduct, description, party }));
    }
  };
