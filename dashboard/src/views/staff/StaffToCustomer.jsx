                ...
                <div className='flex w-full h-full relative'>
                    ...
                    <div className='w-full md:w-[calc(100%-200px)] md:pl-4'>
                        ...
                        <form onSubmit={send} className='flex gap-3'>
                            <input readOnly={customerId ? false : true} onChange={(e) => setText(e.target.value)} value={text} className='w-full flex justify-between px-2 border border-slate-700 items-center py-[5px] focus:border-blue-500 rounded-md outline-none bg-transparent text-[#d0d2d6]' type="text" placeholder='Type your opinion' />
