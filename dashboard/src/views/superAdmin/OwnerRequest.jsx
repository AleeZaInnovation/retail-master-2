...
import { get_owner_request } from "../../store/reducers/ownerReducer";
const OwnerRequest = () => {
  ...
  return (
    <div className="px-2 lg:px-7 pt-5">
      ...
      <div className="w-full flex justify-end mt-4 bottom-4 right-4 mb-3">
        <Link className="p-[6px] bg-blue-500 rounded hover:shadow-lg hover:shadow-blue-500/50" to='/super-admin/dashboard/owners'>All Owners</Link>
      </div>
        <Search
