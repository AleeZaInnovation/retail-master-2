...
const Category = () => {
  ...
  const [imageShow, setImage] = useState(category?.image);
  ...
  const update_category = (e) => {
    ...
    dispatch(categoryUpdate(formData));
  };
                    ...
                    <tr key={i}>
                      ...
                      >
                        <div className="flex justify-start items-center gap-4">
                          <Link
                            onClick={(e) => dispatch(get_category(d._id))}
                    ...
                    >
                      {category?.image ? (
                        <img
                          ...
                          src={imageShow ? imageShow : category?.image}
                        />
                      ) : (
                        <>
                          <span>
