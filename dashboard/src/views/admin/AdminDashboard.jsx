...
import { get_company_orders } from "../../store/reducers/orderReducer";
...
const AdminDashboard = () => {
  const { totalSales, totalOrder, totalProducts, totalSellers } = useSelector((state) => state?.dashboard);
      ...
      <div className="w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-7">
        <div className="flex justify-between items-center p-5 bg-[#283046] rounded-md gap-3">
          <div className="flex flex-col justify-start items-start text-[#d0d2d6]">
            ...
            <span className="text-md font-medium">Total Sales </span> <span>in Current Month</span>
          </div>
        ...
        <div className="flex justify-between items-center p-5 bg-[#283046] rounded-md gap-3">
          <div className="flex flex-col justify-start items-start text-[#d0d2d6]">
            ...
            <span className="text-md font-medium">Orders</span><span>in Current Month</span>
          </div>
