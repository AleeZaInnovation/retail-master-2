...
const Orders = () => {
  ...
  const [branchOrders, setBranchOrders] = useState(orders);
  ...
  const orderView = (orderId) => {
    dispatch(get_company_order(orderId));
    setView(false);
  };
  ...
  }, [companyBranch, orders]);

  const handleBranchChange = (value) => {
    const nOrders = [];
    orders.forEach((order) => {
      if (order.branchId === value) {
        nOrders.push(order);
      }
    });
    setBranchOrders(nOrders);
  };
  return (
    <>
      {view ? (
        <div className="px-2 lg:px-7 pt-5">
          <div className="w-full p-4  bg-[#283046] rounded-md">
            <div className="px-4 py-2 flex justify-between mb-2 bg-sky-900 shadow-lg focus:border-indigo-500 outline-none bg-[#283046] border border-slate-700 rounded-md text-[#eff0f3]">
              <Link
            ...
            <div className="relative mt-5 overflow-x-auto">
              <div className="flex flex-col w-full gap-1 relative">
                ...
                <div className="h-10 w-[200px]">
                  ...
                  />
                  <div
                    className={`absolute top-[101%] bg-slate-200 w-[210px] transition-all ${branchShow ? "scale-100" : "scale-0"
                      }`}
                  >
              ...
              <div className="w-full text-sm text-left [#d0d2d6]">
                <div className="text-sm text-[#d0d2d6] uppercase border-b border-slate-700">
                  <div className="flex justify-between items-start">
                    ...
                    <div className="py-3 w-[20%]">Bill To</div>
              ...
              >
                ...
                <div class="flex flex-row justify-between py-3 dark:text-gray-300">
                  <div class="flex-1">
                    ...
                    <br />
                    {myOrder?.party?.name} <br /> {myOrder?.party?.address}
                    <br /> {myOrder?.party?.mobile}
                    <br />
                    <strong>Total Due :</strong>
                    <br />
                    {myOrder?.party?.balance}
                  </div>
                  <div class="flex-1">
                    <div class="flex justify-between mb-2">
                      <div class="flex-1 dark:text-gray-300 font-semibold">
                        Invoice ID#:
                      </div>
                ...
                <div class="py-4">
                  <table class="table-bordered w-full ltr:text-left rtl:text-right text-gray-600">
                    ...
                    <tfoot>
                      ...
                      <tr class="text-center items-center  dark:text-gray-300 font-bold">
                        {myOrder?.description
                          ? myOrder.description
                          : "Thanks for Shopping"}
                      </tr>
