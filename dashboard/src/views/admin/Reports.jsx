...
const Reports = () => {
  ...
  const incomeStatement = (obj) => {
    ...
    navigate("/admin/dashboard/income-statements");
  };

  const balanceSheet = (obj) => {
    dispatch(balance_sheet(obj));
    navigate("/admin/dashboard/balance-sheet");
  };
  const accountTypeHandler = (obj) => {
    dispatch(account_type_parties(obj));
    setAccountType(obj);
  };
  const accountTypeReport = (obj) => {
    dispatch(account_type(obj));
    navigate("/admin/dashboard/account-type");
  };

  const dayBook = (obj) => {
    dispatch(day_book(obj));
    navigate("/admin/dashboard/day-book");
  };
        ...
        {paymentView ? (
          <div className="w-full grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-7">
            <div className="flex flex-col text-[#d0d2d6] justify-between items-center p-5 bg-[#283046] rounded-md gap-3">
              <div className="flex flex-col justify-center  w-full gap-1 mt-3 relative">
                <select
                  ...
                  name=""
                  id=""
                  className="px-4 py-2 focus:border-indigo-500 text-center dark:text-gray-300 outline-none bg-[#f8f8f9] border border-slate-700 rounded-md text-[#101010]"
                >
                  {" "}
            ...
            <div className="flex  flex-col justify-between text-[#d0d2d6] items-center p-5 bg-[#283046] rounded-md gap-3">
              <div className="flex flex-row justify-between items-center  w-full  mt-3 relative">
              ...
              <div>
                <span
                  ...
                  className="px-5 py-[6px] rounded-sm hover:shadow-orange-500/20 hover:shadow-lg bg-orange-500 text-sm cursor-pointer dark:text-gray-300 text-white uppercase"
                >
                  Search
                </span>
              </div>
            ...
            <div className="flex  flex-col justify-between text-[#d0d2d6] items-center p-5 bg-[#283046] rounded-md gap-3">
              ...
              <div className="flex flex-row justify-between items-center  w-full  relative">
                ...
                <span
                  ...
                  className="px-5 py-[6px] rounded-sm hover:shadow-blue-500/20 hover:shadow-lg bg-blue-500 text-sm cursor-pointer dark:text-gray-300 text-white uppercase"
                >
                  Search
                </span>
              </div>
            ...
            <div className="flex  flex-col justify-between text-[#d0d2d6] items-center p-5 bg-[#283046] rounded-md gap-3">
              ...
              <div className="flex flex-row justify-between items-center  w-full  relative">
                ...
                <span
                  ...
                  className="px-5 py-[6px] rounded-sm hover:shadow-green-500/20 hover:shadow-lg bg-green-500 text-sm cursor-pointer dark:text-gray-300 text-white uppercase"
                >
                  Search
                </span>
              </div>
      ...
      <div className="flex gap-3 mt-2 ">
        {typeView ? (
          <div className="w-full grid grid-cols-1 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-7">
            ...
            <div className="flex  flex-col justify-between text-[#d0d2d6] items-center p-5 bg-[#283046] rounded-md gap-3">
              <div className="flex flex-col justify-center  w-full gap-1 mt-3 relative">
                <div className="flex flex-row justify-between gap-1 items-center  w-full relative">
                  <span className="flex flex-col justify-center  w-full gap-1 relative">
                    <select
                      value={accountType}
                      onChange={(e) => accountTypeHandler(e.target.value)}
                      name=""
